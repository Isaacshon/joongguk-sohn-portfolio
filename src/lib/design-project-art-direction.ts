...
const artDirectionByMotif = {
  ...
  "muji-household": {
    ...
    gallery: "ledger",
    fonts: {
      display: '"Noto Sans JP", "Hiragino Kaku Gothic ProN", "Helvetica Neue", Arial, sans-serif',
      accent: '"Noto Sans JP", "Hiragino Kaku Gothic ProN", "Helvetica Neue", Arial, sans-serif',
      body: '"Noto Sans JP", "Hiragino Kaku Gothic ProN", "Helvetica Neue", Arial, sans-serif',
      meta: '"Noto Sans JP", "Helvetica Neue", Arial, sans-serif',
    },
    title: { weight: 500, style: "normal", leading: ".94", tracking: "-.025em", measure: "16ch" },
    surfaces: {
      paper: "#ffffff",
      ink: "#111111",
      panel: "#f5f5f2",
  ...
  "levis-record": {
    ...
    title: { weight: 700, style: "normal", leading: ".84", tracking: "-.04em", measure: "12ch" },
    surfaces: {
      paper: "#ffffff",
      ink: "#111111",
      panel: "#f4f4f2",
  ...
  "polo-long-match": {
    ...
    title: { weight: 400, style: "normal", leading: ".94", tracking: "-.025em", measure: "15ch" },
    surfaces: {
      paper: "#ffffff",
      ink: "#111111",
      panel: "#f6f6f4",
  ...
  "nike-no-second-take": {
    ...
    title: { weight: 700, style: "normal", leading: ".82", tracking: "-.04em", measure: "10ch" },
    surfaces: {
      paper: "#ffffff",
      ink: "#111111",
      panel: "#f4f4f4",
...
const fontHrefByMotif = {
  ...
  "polo-long-match": "https://fonts.googleapis.com/css2?family=Libre+Caslon+Display&display=swap",
  "nike-no-second-take":
    "https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@500;600;700;800&display=swap",
